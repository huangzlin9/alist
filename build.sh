...
FetchWebDev() {
  curl -L curl -L https://codeload.github.com/huangzlin9/web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/huangzlin9/alist-web/releases/latest/download/dist.tar.gz -o dist.tar.gz
